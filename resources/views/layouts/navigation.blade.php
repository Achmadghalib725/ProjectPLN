        ...
        <div class="mt-4 px-3 space-y-2">
            ...
            <a href="{{ route('dashboard') }}" 
               ...
               :class="!sidebarOpen ? 'justify-start md:justify-center' : ''">
                ...
                <svg class="w-6 h-6 shrink-0 transition-transform duration-300 group-hover:scale-110 {{ request()->routeIs('dashboard') ? 'text-pln-primary' : 'text-gray-400 group-hover:text-pln-light' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
