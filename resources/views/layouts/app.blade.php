            ...
            <div class="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                ...
                <div class="md:hidden bg-white border-b border-gray-200 p-4 flex items-center justify-between z-10">
                    <div class="flex items-center gap-3">
                        <button @click="sidebarOpen = true" class="text-gray-500 hover:text-[#00aff0] focus:outline-none">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                            </svg>
                        </button>
                        <span class="font-bold text-lg text-[#00aff0]">E-Gudang PLN</span>
                    </div>
                    <div class="h-8 w-8 rounded-full bg-[#00aff0] text-white flex items-center justify-center font-bold text-xs">
