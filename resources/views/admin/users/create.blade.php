                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="name" class="block w-full border-gray-200 focus:ring-cyan-500 focus:border-cyan-500 rounded-xl transition-all" type="text" name="name" :value="old('name')" required autofocus placeholder="Masukkan nama lengkap..." />
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="email" class="block w-full border-gray-200 focus:ring-cyan-500 focus:border-cyan-500 rounded-xl transition-all" type="email" name="email" :value="old('email')" required placeholder="alamat@email.com" />
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="password" class="block w-full border-gray-200 focus:ring-cyan-500 focus:border-cyan-500 rounded-xl transition-all" type="password" name="password" required />
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="password_confirmation" class="block w-full border-gray-200 focus:ring-cyan-500 focus:border-cyan-500 rounded-xl transition-all" type="password" name="password_confirmation" required />
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="jabatan" class="block w-full border-gray-200 focus:ring-cyan-500 focus:border-cyan-500 rounded-xl transition-all" type="text" name="jabatan" :value="old('jabatan')" placeholder="Contoh: Manager Operasional" />
                            </div>
