    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mt-2">Edit Item</h2>
                <p class="text-sm text-gray-600 mt-1">{{ $item->nama }}</p>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.items.update', $item->id) }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="kode" name="kode" type="text"
                                          class="mt-1 block w-full" :value="old('kode', $item->kode)" required
                        ...
                        <div>
                            ...
                            <x-text-input id="nama" name="nama" type="text"
                                          class="mt-1 block w-full" :value="old('nama', $item->nama)" required
                        ...
                        <div>
                            ...
                            <x-text-input id="kategori" name="kategori" type="text"
                                          class="mt-1 block w-full" :value="old('kategori', $item->kategori)" required
                        ...
                        <div>
                            ...
                            <x-text-input id="satuan" name="satuan" type="text"
                                          class="mt-1 block w-full" :value="old('satuan', $item->satuan)" required
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="3"
                                      ...
                                      placeholder="Deskripsi detail tentang item...">{{ old('deskripsi', $item->deskripsi) }}</textarea>
        ...
        function previewImage(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    // Hide current image when new image selected
