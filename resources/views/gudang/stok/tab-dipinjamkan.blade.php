    ...
    <div class="p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="inline-flex rounded-lg border border-gray-200 p-1 bg-gray-50">
                <a href="{{ route('gudang.stok.index', array_merge(request()->except('sort'), ['tab' => 'dipinjamkan', 'sort' => 'terbaru'])) }}"
                   data-ajax-tab data-ajax-target="#stok-content"
                ...
                <a href="{{ route('gudang.stok.index', array_merge(request()->except('sort'), ['tab' => 'dipinjamkan', 'sort' => 'terlama'])) }}"
                   data-ajax-tab data-ajax-target="#stok-content"
