        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Barang Pinjaman</h2>
                        <p class="text-sm text-gray-500 mt-1">Daftar barang yang gudang Anda pinjam dari gudang lain</p>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-gray-500">Harus Segera Dikembalikan</p>
                ...
                <div class="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-red-700">Anda memiliki {{ $totalOverdue }} pinjaman yang sudah melewati batas waktu pengembalian. Segera lakukan pengembalian.</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
                <form method="GET" class="flex flex-col sm:flex-row gap-4">
                    ...
                    @if(request()->hasAny(['search', 'status']))
                        <a href="{{ route('gudang.stok.barang-pinjaman') }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                            Reset
                        </a>
                    @endif
                </form>
