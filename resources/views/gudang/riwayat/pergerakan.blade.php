...
<div class="bg-white overflow-hidden shadow-sm rounded-xl mb-4 sm:mb-6" x-data="{ showFilter: false }">
    ...
    <div x-show="showFilter"
        ...
        <div class="px-4 pb-4 border-t border-gray-100 pt-4">
            <form method="GET" action="{{ route('gudang.riwayat') }}" id="filterForm" data-ajax-form data-ajax-target="#riwayat-content">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($movements ?? [] as $index => $movement)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $movements->firstItem() + $index }}</td>
