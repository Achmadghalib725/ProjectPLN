...
<head>
    ...
    <style>
        * {
        ...
        .type-transfer { background: #e9d5ff; color: #7c3aed; }
        .type-peminjaman { background: #dbeafe; color: #2563eb; }
        .type-pengembalian { background: #dcfce7; color: #16a34a; }
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header-left">
                ...
                <div class="company-subtitle">Sistem Manajemen Gudang - {{ $suratJalan->gudangAsal->nama ?? 'Gudang' }}</div>
            </div>
        ...
        <div class="info-section">
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">: {{ $suratJalan->tanggal ? $suratJalan->tanggal->format('d F Y') : now()->format('d F Y') }}</div>
                </div>
                <div class="info-row">
