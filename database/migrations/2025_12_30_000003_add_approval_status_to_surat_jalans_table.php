...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $statuses = "'DRAFT','MENUNGGU_PERSETUJUAN','DITOLAK_PERSETUJUAN','DIKIRIM','DIPERIKSA','DITERIMA','DIKEMBALIKAN','DITOLAK','MENUNGGU_DIKEMBALIKAN','SELESAI'";
    ...
    public function down(): void
    {
        ...
        $statuses = "'DRAFT','DIKIRIM','DIPERIKSA','DITERIMA','DIKEMBALIKAN','DITOLAK','MENUNGGU_DIKEMBALIKAN','SELESAI'";
